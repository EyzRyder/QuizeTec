  ...
  return (
    <View className='flex-1 items-center'>
      <View className='flex-row pt-10'>
        ...
        <Text className='flex-1 font-title font-semibold text-2xl leading-tight text-[#2A416F]'>Sobre</Text>
      </View>
      <ScrollView className='flex-1 px-8'>
        <Text className='text-2xl font-title text-center font-semibold text-[#2A416F] my-6'>O Motivo do desenvolvimento?</Text>
        <View className='bg-blue-500 px-7 py-6 rounded-lg mb-14'>
          <Text className='text-white text-lg font-body font-light'>
        ...
        <Text className='text-2xl text-[#2A416F] font-title font-semibold text-center mb-6'>Por Quem?</Text>
