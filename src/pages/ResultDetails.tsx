...
export default function ResultDetails() {
  ...
  const userAnswer = quizAnswers.usersAnswer.filter(
    (ua) => ua.userId == userId,
  )[0].pastAnswers;
                    ...
                    {item.questions.map((q: AnsweringType, index) => (
                      <div key={q.id} className="flex flex-col ">
                        ...
                        <span
                          ...
                          className="border-2 p-3 font-extrabold rounded-xl data-[isright=true]:text-green-500 data-[isright=true]:bg-green-500/10 data-[isright=true]:border-green-500 text-red-400 data-[isright=false]:bg-red-400/10 data-[isright=false]:border-red-400"
                        >
                          {q.title}
                        </span>
                      </div>
