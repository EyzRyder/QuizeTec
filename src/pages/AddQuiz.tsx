    ...
    <IonContent className="min-h-screen h-full" style={{ height: "100%" }}>
      <div className="flex-1 flex flex-col h-full w-full">
        ...
        <ScrollArea className="flex-1 flex flex-col h-full w-full px-8 py-6">
          <Label className="text-2xl text-[#2A416F]">Título do quiz</Label>
          <Input
            type="text"
            value={quiz?.title}
          ...
          <p className="text-2xl text-[#2A416F]">Tema & Nível</p>
          <Select
          ...
          <div className="flex flex-col">
            <div className="flex flex-row justify-between items-center">
              <span className="font-title text-2xl text-[#2A416F]">
                Questões
              </span>
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      <ScrollArea className="flex flex-col space-y-6 h-76 px-1">
                        <div>
                          <div className="flex flex-row justify-between items-center">
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                      ...
                      onClick={() => {
                        if (!questao) return alert("Falta preencher o Título");
